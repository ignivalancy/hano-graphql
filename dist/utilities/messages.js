...
exports.default = {
  ...
  forgetPassword: 'We have sent you an email on your registered email account to reset your password.',
  resetpassword: 'Your password has been reset successfully!',
  passwordUpdated: 'Your password has been successfully changed. Please login with new password to continue. Thanks!.',
  emailChanged: 'An OTP is sent to the registered email Id. Please use that to verify your email.',
  phoneNumChanged: 'An OTP is sent to the registered phone number. Please use that to verify your phone number.',
  emailUpdated: 'Email updated successfully.',
  loginSuccessfull: 'Logged in successfully.',
  logoutSuccessfull: 'Logged out successfully.',
  invalidCredentials: 'Invalid credentials.',
  accountNotConfirmed: 'Your account is not confirmed.Please confirm verification link sent your registered email.',
  profileUpdate: 'Profile successfully updated.',
  unauthorizedUser: 'You are not an authorized user for this action.',
  forgetPasswordEmail: 'An OTP is sent to the registered email Id. Please use that OTP to access your account.',
